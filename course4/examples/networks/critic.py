...
class Critic(nn.Module):
    def __init__(self, input_size, output_size, hidden_size, num_hidden_layer=2):
        super().__init__()
        ...
        '''
        #LSTM好像输入维度不对
        self.linear_in = nn.LSTM(input_size, hidden_size, num_hidden_layer)  # rnn
